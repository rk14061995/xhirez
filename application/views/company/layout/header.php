  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?=base_url('Agency/dashboard')?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?=base_url('Agency/resumeFilter')?>">
          <!-- <i class="fas fa-fw fa-chart-area"></i> -->
          <span>Resume Filter</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?=base_url('Agency/buyCoin')?>">
          <!-- <i class="fas fa-fw fa-chart-area"></i> -->
          <span>Buy Coins</span>
        </a>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?=base_url('Agency/Details')?>">
                ...
                <a class="dropdown-item" href="<?=base_url('Agency/logOut')?>" >
