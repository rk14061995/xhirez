        ...
        <div class="collapse navbar-collapse bg_white" id="navbarSupportedContent">
          ...
          <!--   <li class="nav-item ">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
              <a class="nav-link" href="#"> Staffing Agencies</a>
            </li>
              <li class="nav-item">
        ...
        <div class="row">
            ...
            <div class="col-md-4 ">
                <div class="card px-4 py-5 mt-5">
                    <h3 class="mb-1 text-center">Company Login</h3>
                    <?php
                    ...
                    <div class="mt-4">
                        <form action="<?=base_url('LoginController/companyLogin')?>" method="post">
                            <div class="form-group">
                                <input type="text" class="form-control" id="email"  name="comp_email" placeholder="Email or Username" required/>
                            </div>
                            <div class="form-group">
