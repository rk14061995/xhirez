                ...
                <div class="col-md-8">
                    <div class="pppDSK">
                        ...
                        <div class="mt-3 shadow  p-4">
                            ...
                            <div class="">
	                            <div class="form__group field">
                                  <textarea class="form__field" name="company_address" id="company_address" rows="4" required ></textarea>
                            ...
                            <div class="row form__group ">
                              <div class="col-md-4">
                                <div class="form__group field">
                                  ...
                                  <input type="text" class="form__field"   name="ugqualification">
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form__group field">
                                  <label class="form__label">PG Qualifications</label>
                                  <input type="text" class="form__field"   name="pgqualification">
                                </div>
                              </div>
                              <div class="col-md-4">
                                <div class="form__group field">
                                  <label class="form__label">Doctorate/Ph.D</label>
                                  <input type="text" class="form__field"   name="doctorate_phd"> 
                                </div>
                              </div>
                            </div>                              
                            <input type="text" value="<?=$companuSession[0]->company_id?>" class="d-none" name="company_id">
...
<script type="text/javascript">
  $(document).on('submit','#postNewJob',function(e){
    ...
    var formData= new FormData($(this)[0]);
         // alert('cas');
      $.ajax({
        url:"<?=base_url('CompanyAdmin/addPost')?>",
         type:"post",
         catche:false,
         contentType:false,
         processData:false,
